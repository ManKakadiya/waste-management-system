...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        default: "border-primary/20 bg-white text-foreground dark:bg-gray-800 dark:text-white",
        destructive:
          "destructive group border-red-500/20 bg-red-50 text-red-800 dark:border-red-500/30 dark:bg-red-900/40 dark:text-red-200",
        success: "border-green-500/20 bg-green-50 text-green-800 dark:border-green-500/30 dark:bg-green-900/40 dark:text-green-200",
        warning: "border-yellow-500/20 bg-yellow-50 text-yellow-800 dark:border-yellow-500/30 dark:bg-yellow-900/40 dark:text-yellow-200",
        info: "border-blue-500/20 bg-blue-50 text-blue-800 dark:border-blue-500/30 dark:bg-blue-900/40 dark:text-blue-200",
      },
    },
    defaultVariants: {
      variant: "default",
